...
-- UNIQUE
IF NOT EXISTS (SELECT 1 FROM [INFORMATION_SCHEMA].[TABLE_CONSTRAINTS] WHERE [CONSTRAINT_NAME] = 'UQ_VIEWS_USER_VIDEO_UID' AND [TABLE_NAME] = N'VIEWS') BEGIN
    ALTER TABLE [VIEWS] ADD CONSTRAINT [UQ_VIEWS_USER_UID] UNIQUE([USER_UID], [VIDEO_UID])
