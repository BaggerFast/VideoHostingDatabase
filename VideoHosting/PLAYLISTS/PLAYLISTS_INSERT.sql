...
END ELSE BEGIN
    ...
    BEGIN
        ...
        WHILE @@FETCH_STATUS = 0 BEGIN
            ...
            IF NOT EXISTS (SELECT 1 FROM [PLAYLISTS] WHERE [USER_UID] = @USER_UID AND [TITLE] = @TITLE AND [ACCESS_UID] = @ACCESS_UID)
                INSERT INTO [PLAYLISTS] ([USER_UID], [ACCESS_UID], [TITLE]) VALUES (@USER_UID, @ACCESS_UID, @TITLE);
            FETCH NEXT FROM CUR INTO @USERNAME, @TITLE, @ACCESS;
        END;
        CLOSE CUR;
        DEALLOCATE CUR;
