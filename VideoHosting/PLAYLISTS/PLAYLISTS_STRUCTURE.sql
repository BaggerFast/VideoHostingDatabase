...
IF NOT EXISTS (SELECT 1 FROM [INFORMATION_SCHEMA].[TABLE_CONSTRAINTS] WHERE [CONSTRAINT_TYPE] = 'PRIMARY KEY' AND [TABLE_NAME] = N'PLAYLISTS') BEGIN
    ALTER TABLE [dbo].[PLAYLISTS] ADD CONSTRAINT [PK_PLAYLISTS_UID] PRIMARY KEY CLUSTERED ([UID] ASC)
...
-- UNIQUE
IF NOT EXISTS (SELECT 1 FROM [INFORMATION_SCHEMA].[TABLE_CONSTRAINTS] WHERE [CONSTRAINT_NAME] = 'UQ_PLAYLISTS_TITLE' AND [TABLE_NAME] = N'PLAYLISTS') BEGIN
    ALTER TABLE [PLAYLISTS] ADD CONSTRAINT [UQ_PLAYLISTS_TITLE] UNIQUE([TITLE])
    PRINT N'➕ UNIQUE KEY [UQ_PLAYLISTS_TITLE] WAS CREATED';
END;
IF NOT EXISTS (SELECT 1 FROM [INFORMATION_SCHEMA].[TABLE_CONSTRAINTS] WHERE [CONSTRAINT_NAME] = 'UQ_PLAYLISTS_ACCESS_UID' AND [TABLE_NAME] = N'PLAYLISTS') BEGIN
    ALTER TABLE [PLAYLISTS] ADD CONSTRAINT [UQ_PLAYLISTS_ACCESS_UID] UNIQUE([ACCESS_UID])
    PRINT N'➕ UNIQUE KEY [UQ_PLAYLISTS_ACCESS_UID] WAS CREATED';
END;
IF NOT EXISTS (SELECT 1 FROM [INFORMATION_SCHEMA].[TABLE_CONSTRAINTS] WHERE [CONSTRAINT_NAME] = 'UQ_PLAYLISTS_USER_UID' AND [TABLE_NAME] = N'PLAYLISTS') BEGIN
    ALTER TABLE [PLAYLISTS] ADD CONSTRAINT [UQ_PLAYLISTS_USER_UID] UNIQUE([USER_UID])
    PRINT N'➕ UNIQUE KEY [UQ_PLAYLISTS_USER_UID] WAS CREATED';
END;
