...
END ELSE BEGIN
    ...
    BEGIN
        ...
        WHILE @@FETCH_STATUS = 0 BEGIN
            ...
            MERGE INTO [REACTIONS] AS [REACTION] 
                USING (VALUES (@USER_UID, @VIDEO_UID, @IS_LIKED)) AS [NEW_REACTION] ([USER_UID], [VIDEO_UID], [IS_LIKED])
                ON [REACTION].[USER_UID] = [NEW_REACTION].[USER_UID] AND [REACTION].[VIDEO_UID] = [NEW_REACTION].[VIDEO_UID]
                WHEN NOT MATCHED THEN
                    INSERT ([VIDEO_UID], [USER_UID], [IS_LIKED]) VALUES (@VIDEO_UID, @USER_UID, @IS_LIKED);
            FETCH NEXT FROM CUR INTO @USERNAME, @VIDEO;
        END;
        CLOSE CUR;
        DEALLOCATE CUR;
