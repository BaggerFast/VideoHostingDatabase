...
END ELSE BEGIN
    ...
    BEGIN
        ...
        WHILE @@FETCH_STATUS = 0 BEGIN
            ...
            IF NOT EXISTS (SELECT 1 FROM [FK_VIDEO_PLAYLISTS]  WHERE [PLAYLIST_UID] = @PLAYLIST_UID AND [VIDEO_UID] = @VIDEO_UID)
                INSERT INTO [FK_VIDEO_PLAYLISTS] ([PLAYLIST_UID], [VIDEO_UID])  VALUES (@PLAYLIST_UID, @VIDEO_UID);
            FETCH NEXT FROM CUR INTO @PLAYLIST, @VIDEO;
        END;
        CLOSE CUR;
        DEALLOCATE CUR;
