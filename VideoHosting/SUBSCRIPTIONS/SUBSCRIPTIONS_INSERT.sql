...
END ELSE BEGIN
    ...
    BEGIN
        ...
        WHILE @@FETCH_STATUS = 0 BEGIN
            ...
            IF NOT EXISTS (SELECT 1 FROM [SUBSCRIPTIONS] WHERE [FROM_USER_UID] = @FROM_USER_UID AND [TO_USER_UID] = @TO_USER_UID)
                INSERT INTO [SUBSCRIPTIONS] ([FROM_USER_UID], [TO_USER_UID]) VALUES (@FROM_USER_UID, @TO_USER_UID);
            FETCH NEXT FROM CUR INTO @FROM_USER, @TO_USER;
        END;
        CLOSE CUR;
        DEALLOCATE CUR;
